...
public class MonitorInfo
{
    ...
    public static unsafe MonitorInfo GetNearestDisplayMonitor(nint hwnd)
    {
        ...
        return nearestMonitorInfo ?? throw new Exception($"{nameof(GetNearestDisplayMonitor)} get monitorInfo is null");
    }
    ...
    public static unsafe MonitorInfo GetPrimaryDisplayMonitor()
    {
        ...
        return primaryMonitorInfo ?? throw new Exception($"{nameof(GetPrimaryDisplayMonitor)} get monitorInfo is null");
    }
    ...
    public static unsafe MonitorInfo GetCursorDisplayMonitor()
    {
        ...
        return cursorMonitorInfo ?? throw new Exception($"{nameof(GetCursorDisplayMonitor)} get monitorInfo is null");
    }
