...
/// <summary>
///     <see href="https://stackoverflow.com/questions/24213964/whats-an-reusable-but-simple-and-efficient-way-to-disallow-special-characters"/>
/// </summary>
        ...
        DependencyPropertyChangedEventArgs e)
    {
        if (dependencyObject is TextBox tb)
        {
            if ((bool)e.NewValue)
            {
                ...
                tb.AddHandler(DataObject.PastingEvent, new DataObjectPastingEventHandler(TextBoxPasting));
            }
            else
            {
                tb.PreviewTextInput -= TextBoxPreviewTextInput;
                tb.RemoveHandler(DataObject.PastingEvent, new DataObjectPastingEventHandler(TextBoxPasting));
            }
        }
    }
